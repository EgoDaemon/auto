...
params = {'dimetions': [{'name': 'ga:isoweek'},
        ...
        'filters':'ga:eventlabel=~NewRegSuccessful;ga:source!~ohio8.vchecks.me'
        }
...
params = {'dimetions': [{'name': 'ga:isoweek'},
        ...
        'filters':'ga:eventlabel=~NewRegSuccessful;ga:landingpagepath=~/nedvizhimost;ga:source!~ohio8.vchecks.me'
        }
